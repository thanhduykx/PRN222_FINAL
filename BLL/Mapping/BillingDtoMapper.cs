...
public static class BillingDtoMapper
{
    public static Package ToModel(KnowledgeSqlPackage entity) => new()
    {
        ...
        PriceVnd = entity.PriceVnd, DurationDays = entity.DurationDays,
        MonthlyChatLimit = entity.MonthlyChatLimit,
        MonthlyDocumentUploadLimit = entity.MonthlyDocumentUploadLimit,
        StorageLimitMb = entity.StorageLimitMb, IsLifetime = entity.IsLifetime,
    ...
    public static Payment ToModel(KnowledgeSqlPayment entity) => new()
    {
        ...
        Provider = (PaymentProvider)entity.Provider, Status = (PaymentStatus)entity.Status,
        AmountVnd = entity.AmountVnd, Currency = entity.Currency, OrderCode = entity.OrderCode,
        ProviderTransactionId = entity.ProviderTransactionId, CheckoutUrl = entity.CheckoutUrl,
        QrCode = entity.QrCode, RawRequest = entity.RawRequest, RawResponse = entity.RawResponse,
        RawWebhook = entity.RawWebhook, CreatedAt = entity.CreatedAt, PaidAt = entity.PaidAt,
        FailedAt = entity.FailedAt, FailureReason = entity.FailureReason,
    ...
    public static KnowledgeSqlPayment ToEntity(Payment model) => new()
    {
        ...
        UserName = model.UserName, UserEmail = model.UserEmail,
        Provider = (DAL.Enums.PaymentProvider)model.Provider,
        Status = (DAL.Enums.PaymentStatus)model.Status,
        AmountVnd = model.AmountVnd, Currency = model.Currency, OrderCode = model.OrderCode,
        ProviderTransactionId = model.ProviderTransactionId, CheckoutUrl = model.CheckoutUrl,
    ...
    public static KnowledgeSqlSubscription ToEntity(Subscription model) => new()
    {
        Id = model.Id, PackageId = model.PackageId, UserId = model.UserId,
        UserName = model.UserName, UserEmail = model.UserEmail,
        Status = (DAL.Enums.SubscriptionStatus)model.Status, StartsAt = model.StartsAt,
        EndsAt = model.EndsAt, PaymentId = model.PaymentId, CreatedAt = model.CreatedAt
    };
